...
"}")
        ...
        self.previewsLayout = QVBoxLayout(self.previewsFrame)
        self.previewsLayout.setObjectName(u"previewsLayout")
        self.previewsLayout.setContentsMargins(0, 0, 0, 0)
        ...
        self.resultLayout = QHBoxLayout(self.resultPreview)
        ...
        self.previewsLayout.addWidget(self.previewsSplitter)

        self.centralSplitter.addWidget(self.previewsFrame)

        self.centralLayout.addWidget(self.centralSplitter, 0, 0, 1, 1)

        self.centralSplitter.setSizes([1000, 5000])
        self.previewsSplitter.setSizes([3000, 3000])
